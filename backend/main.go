...
func main() {
	...
	http.HandleFunc("/my_groups", handlers.GetGroupsHandler)
	http.HandleFunc("/discover_groups", handlers.GetDiscoverGroupsHandler)
	http.HandleFunc("/pinding_groups", handlers.GetPindingGroupsHandler)
